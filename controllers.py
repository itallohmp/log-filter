...
from main import BASE_LOGS
from fastapi.responses import FileResponse, JSONResponse, StreamingResponse

import paramiko, json, re, glob, os, subprocess
...
def listar_rotas():
    try:
        ...
        return JSONResponse(
            {"erro": f"Erro ao listar rotas: {str(e)}"},
            status_code=500
        )
...
def filter_logs(
    ...
    try:
        ...
        if not hora_de and not hora_ate:
            ...
            for p in arquivos_ordenados:
                ...
                if h in horas_incluir:
                    arquivos_filtrados.routerend(p)
        ...
        return StreamingResponse(stream_logs(), media_type="routerlication/x-ndjson")
